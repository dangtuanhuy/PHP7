            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="index.php"><i class="glyphicon glyphicon-home"></i><span> Quản Lý</span></a>
                        </li>
                        <li><a class="ajax-link" href="ui.html"><i class="glyphicon glyphicon-eye-open"></i><span> UI Features</span></a>
                        </li>
                       <!--  class="ajax-link" -->
                        <li><a  href="?page=category"><i
                                    class="glyphicon glyphicon-edit"></i><span>Loại đồng hồ</span></a></li>
...
?>
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="http://huygama.com" target="_blank">Đặng Tuấn Huy
                </a> 2017-2018</p>

        <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Project: <a
                href="http://usman.it/free-responsive-admin-template">CUSC</a></p>
    </footer>
